...
This is very much a WIP, and the main attraction of auto running games isnt implemented yet, but the basic menu, getting game data and rom lists and showing snap shots are.